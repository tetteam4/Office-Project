...
export const Portfolio_Data = [
    ...
    },
    {
      ...
      description: {
        projectOverview: "An e-commerce platform specializing in sneakers and sports shoes...",
        frontendSection: "Built with React.js and Tailwind, featuring product filtering, search, and cart functionality.",
        backendSection: "Node.js and Express handle authentication, product management, and order processing.",
        databaseSection: "MongoDB stores user data, orders, and inventory details.",
        usageSection: "Users can browse shoes, add to cart, and purchase using Stripe payment.",
        otherTechnologies: "Stripe API enables secure transactions and Redux manages state."
      }
    },
    {
      ...
      description: {
        projectOverview: "A comprehensive school management system for student registration and course tracking...",
        frontendSection: "React.js and Bootstrap provide an intuitive dashboard for teachers and students.",
        backendSection: "Django & GraphQL enable efficient data management for student performance tracking.",
        databaseSection: "PostgreSQL is used for scalable data storage.",
        usageSection: "Admins manage school activities, teachers upload assignments, and students access schedules.",
        otherTechnologies: "Firebase supports notifications and Docker ensures smooth deployment."
      }
    },
    {
      ...
      description: {
        projectOverview: "A personal portfolio showcasing web development projects and skills...",
        frontendSection: "Built with Next.js and Tailwind CSS for performance and responsiveness.",
        backendSection: "Sanity CMS is used for blog and content management.",
        databaseSection: "No database required as content is managed through Sanity.",
        usageSection: "Visitors can explore projects, read blogs, and contact me.",
        otherTechnologies: "Framer Motion adds animations and Vercel ensures fast deployment."
      }
    },
    {
      ...
      description: {
        projectOverview: "A real-time chat application with group and private messaging...",
        ...
        usageSection: "Users can chat privately or in groups, with media sharing support.",
